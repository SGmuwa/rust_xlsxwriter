...
// Test the default pivot table output: the values of the fields used on an
// axis and the extent of the pivot table are written to the file.
...
#[test]
fn test_pivot_table03() {
    let test_runner = common::TestRunner::new()
        .set_name("pivot_table03")
