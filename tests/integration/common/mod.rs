...
// Sample data for the pivot table tests. This is the same data as in
// examples/app_autofilter.rs, which was used to create the reference files.
pub fn get_pivot_table_data() -> Vec<(&'static str, &'static str, u16, &'static str)> {
    vec![
